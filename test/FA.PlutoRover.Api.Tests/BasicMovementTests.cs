...
namespace FA.PlutoRover.Api.Tests
{
    ...
    public class BasicMovementTests
    {
        ...
        [Test]
        public void MoveBackward_StartAtGridBoundary_OrientatedEast_WrapAround()
        {
            //Arrange
            var grid = new Point(10, 10);
            var start = new Point(PlutoRover.ROOT_X, PlutoRover.ROOT_Y);
        ...
        [Test]
        public void MoveBackward_StartAtGridBoundary_OrientatedSouth_WrapAround()
        {
            //Arrange
            var grid = new Point(10, 10);
            var start = new Point(PlutoRover.ROOT_X, grid.Y);
        ...
        [Test]
        public void MoveBackward_StartAtGridBoundary_OrientatedWest_WrapAround()
        {
            //Arrange
            var grid = new Point(10, 10);
